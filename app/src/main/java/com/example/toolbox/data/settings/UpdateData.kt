...
val updateLogs = listOf(
    VersionUpdate(
        ...
        date = "2026/3/29",
        logs = listOf(
            UpdateLogItem("新增2048游戏", UpdateLogType.NEW),
            UpdateLogItem("新增检查更新功能", UpdateLogType.NEW),
            UpdateLogItem("优化UI", UpdateLogType.IMPROVE),
            UpdateLogItem("修复资源库崩溃", UpdateLogType.FIX),
            UpdateLogItem("修复细节问题", UpdateLogType.FIX),
            UpdateLogItem("修改我的页面顶栏问题", UpdateLogType.FIX)
        )
    ),
    VersionUpdate(
        version = "0.0.9",
